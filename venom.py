...
FORWARD_CHANNEL_ID = -1002438009584
CHANNEL_ID = -1002438009584
error_channel_id = -1002438009584
...
def send_welcome(message):
    ...
    # Create buttons
    btn1 = KeyboardButton("VENOMPAPA 🧡")
    btn2 = KeyboardButton("VENOMPAPA 💥")
    btn3 = KeyboardButton("CREDIT NHI DIYA TO FUCK✔️")
...
def handle_message(message):
    if message.text == "VENOMPAPA 🧡":
        bot.reply_to(message, "*Instant Plan selected*", parse_mode='Markdown')
    elif message.text == "VENOMPAPA 💥":
        bot.reply_to(message, "*Instant++ Plan selected*", parse_mode='Markdown')
        attack_command(message)
    elif message.text == "CREDIT NHI DIYA TO FUCK✔️":
